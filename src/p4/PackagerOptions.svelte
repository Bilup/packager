    ...
    >
      <div>
        ...
        {:else}
          ...
          <div class="warning">
            <div>{$_('options.nativeAppWarning')}</div>
            <ul>
              <li>{$_('options.nativeAppAdvantage1')}</li>
              <li>{$_('options.nativeAppAdvantage2')}</li>
              <li>{$_('options.nativeAppAdvantage3')}</li>
              <li>{$_('options.nativeAppAdvantage4')}</li>
            </ul>
            <div>{$_('options.nativeAppRecommendation')}</div>
          </div>

          {#if $options.target.includes('win')}
            <div>
              <h2>Windows</h2>
              <p>{$_('options.windowsAppInfo')}</p>
              <p>{$_('options.windowsAppIconInfo')}</p>
            </div>
          {:else if $options.target.includes('mac')}
            <div>
              <h2>macOS</h2>
              <p>{$_('options.macOSAppInfo')}</p>
              <ul>
                <li>{$_('options.macOSAppOption1')}</li>
                <li>{$_('options.macOSAppOption2')}</li>
              </ul>
            </div>
          {:else if $options.target.includes('linux')}
            <div>
              <h2>Linux</h2>
              <p>{$_('options.linuxAppInfo')}</p>
            </div>
          {/if}
          ...
          {#if $options.target.includes('electron')}
            <div>
              <h2>Electron</h2>
              <p>{$_('options.electronInfo')}</p>

              {#if $options.target.includes('win')}
                {#if $options.target.includes('32')}
                  <p>{$_('options.electronWinInfo')}</p>
                {/if}
              {:else if $options.target.includes('mac')}
                <p>{$_('options.electronMacInfo')}</p>
              {:else if $options.target.includes('linux')}
                <p>{$_('options.electronLinuxInfo')}</p>
              {/if}
            </div>
          {:else if $options.target.includes('nwjs')}
            <div>
              <h2>NW.js</h2>
              <p class="warning">{$_('options.nwjsInfo')}</p>
              <p>{$_('options.nwjsDescription')}</p>
              <p>{$_('options.nwjsDocumentation')}</p>
              {#if $options.target.includes('mac')}
                <p>{$_('options.nwjsMacInfo')}</p>
              {/if}
            </div>
          {:else if $options.target.includes('webview-mac')}
            <div>
              <h2>WKWebView</h2>
              <p>{$_('options.wkwebviewInfo')}</p>
              <p>{$_('options.wkwebviewCompatibility')}</p>
              <p>{$_('options.wkwebviewNote')}</p>
              <ul>
                <li>{$_('options.wkwebviewLimitation1')}</li>
                <li>{$_('options.wkwebviewLimitation2')}</li>
                <li>{$_('options.wkwebviewLimitation3')}</li>
              </ul>
              <p>{$_('options.wkwebviewAlternative')}</p>
            </div>
          {/if}
        {/if}
      </div>
