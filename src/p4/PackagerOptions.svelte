<script>
  ...
  // Compatibility with https://github.com/Bilup/packager/commit/f66199abd1c896c11aa69247275a1594fdfc95b8
        ...
        {:else}
          ...
          {#if $options.target.includes('win')}
            <div>
              ...
              <p>To change the icon of the executable file or create an installer program, download and run <a href="https://github.com/Bilup/packager-extras/releases">Bilup Packager Extras</a> and select the output of this website.</p>
            </div>
